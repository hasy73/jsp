...
<div class="container">
  <div class="header"><img src="pic/logo.jpg" width="960" height="250"></div>
  <div class="content">
    <h1>電視劇推薦★</h1>
    <p></p>

<div class="myDiv"><img src="pic/nine.jpg" width="275" height="122">  身懷絕症的新聞主播朴宣友獲得可以回到二十年前的九炷香後，於現在和過去來回穿梭而展開的故事。透過時間旅行改變過去，試圖來挽回現實中無法解決的問題，但是改變之後所產生的不穩定因素卻使現實變得更加複雜，隱藏不少反轉的趣味在其中。<div class="myDivtt">
推薦:★★★★★
</div>
</div>
