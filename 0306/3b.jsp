...
<div class="container">
  ...
  <div class="content">
	...
	String p3=request.getParameter("no");
	
	if(p1.equals(p2) && p1.length()>=8 && p1.length()<=15){
	...
	boolean flag=true;
	p4=p3.charAt(0);
	p5=p3.charAt(p3.length()-1);
	if(p3.length<2){
		flag=false;}
	if(p4='A'&& !p5='0' && !p5='1'&& !p5='2'){
		flag=false;
	}else if(p4='B'&& !p5='3' && !p5='4'&& !p5='5'){
		flag=false;
	}else if(p4='C'&& !p5='6' && !p5='7'&& !p5='8'){
		flag=false;
	}else if(p4='D'&& !p5='9' && !p5='0'){
		flag=false;
	}else if((int)p4>69 && (int)p4<90 && !((int)p5>65 && (int)p5<90))
		flag=false;
