...
//建立SQL命令物件
PreparedStatement stmt = con.prepareStatement("select * from customer where cusNo=?"); 
...
<form action="1c.jsp" method="post"><p>
客戶編號:<input name="no" type="text" value="<%=num%>" readonly>
<br/>
客戶編號:<input name="name" type="text" value="<%=rs.getString("cusName")%>" maxlength="30" >
<br/>
地址:<input name="address" type="text" value="<%=rs.getString("address")%>" >
<br/>
<input type="submit" value="更改"></p>
</form>
