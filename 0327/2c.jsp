...
String ext = new String(request.getParameter("ext").getBytes("iso-8859-1"), "utf-8").trim();
...
//建立SQL命令物件
PreparedStatement stmt = con.prepareStatement("update employee set empName=?, ext=? where empNo=?"); 
...
out.println("已更改" + r + "筆記錄");
stmt.close(); 
con.close(); 
%>
    </p>
    <p><a href="2a.jsp">返回</a></p>
    <!-- end .content --></div>
  <div class="footer">
    <p>頁尾</p>
    <!-- end .footer --></div>
