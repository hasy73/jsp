...
<div class="container">
  ...
  <div class="content">
    ...
    <% 
//取得傳入參
String num=request.getParameter("eNo"); 
...
<form action="2c.jsp" method="post">
  <p>
員工編號:
  <input name="no" type="text" value="<%=num%>" readonly>
<br/>
姓名:
<input name="name" type="text" value="<%=rs.getString("empName")%>" maxlength="30" >
<br/>
分機:
<input name="ext" type="text" id="ext" value="<%=rs.getString("ext")%>" >
<br/>
