...
<div class="container">
  ...
  <div class="content">
    ...
    <% 
//取得傳入參數
String cNo = request.getParameter("no").trim();
String cName = new String(request.getParameter("name").getBytes("iso-8859-1"), "utf-8").trim();
String add = new String(request.getParameter("add").getBytes("iso-8859-1"), "utf-8").trim();
...
//建立SQL命令物件
PreparedStatement stmt = con.prepareStatement("insert into customer(cusNo, cusName, address) values (?, ?, ?)"); 
