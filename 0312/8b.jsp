...
<div class="container">
  ...
  <div class="content">
    ...
    <% 
		String num=request.getParameter("no"); //取得傳入的參數 
		...
		//用來放執行 SQL 指令的結果 
		ResultSet rs; 
		rs=stmt.executeQuery("select * from supplier where supNo='"+num+"'"); 
		...
		do{ //以迴圈取出執行 SQL 後的結果 
	 		out.println("supNo:"); 
 			out.println(rs.getString("supNo")); 
 			out.println("<br>"); 
			
			out.println("supName:"); 
			out.print(rs.getString("supName"));
			out.println("<br>"); 
