...
<div class="container">
  ...
  <div class="content">
	...
	PreparedStatement stmt = con.prepareStatement("select a.proNo, a.proName, a.price, b.supName from product a, supplier b where a.supNo =b.supNo and a.proNo>=? and a.proNo<=?"); 
	stmt.setString(1, num1.trim()); 
	stmt.setString(2, num2.trim()); 
...
<table>
    ...
    <td style="width:220px">產品名稱</td>
    <td style="width:80px">單價</td>
    <td style="width:200px">供應商</td>
    </tr>
	...
	do{ 
		out.println("<tr><td>"); 
		out.println(rs.getString("proNo")); 
		out.println("</td><td>");
		...
		out.println(p);
		out.println("</td><td>"); 
		out.println(rs.getString("supName")); 
		out.println("</td></tr>");
