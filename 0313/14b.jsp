...
<div class="container">
  ...
  <div class="content">
	...
	PreparedStatement stmt = con.prepareStatement("select a.proNo, a.proName, a.price, b.supName from product a, supplier b where a.supNo =b.supNo and a.proNo=?"); 
	stmt.setString(1, num.trim()); 
